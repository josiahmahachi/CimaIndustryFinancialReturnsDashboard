(() => {
  ...
  var require_lucide = __commonJS({
    "node_modules/lucide/dist/cjs/lucide.js"(exports) {
      ...
      var ChevronLeft2 = [["path", { d: "m15 18-6-6 6-6" }]];
      var ChevronRight2 = [["path", { d: "m9 18 6-6-6-6" }]];
      var ChevronsDownUp = [
      ...
      exports.ClipboardList = ClipboardList2;
  ...
  // src/scripts/lucide-bundle.js
  var import_lucide = __toESM(require_lucide());
  window.LucideIcons = {
    createIcons: import_lucide.createIcons,
    icons: {
      Home: import_lucide.Home,
      FileText: import_lucide.FileText,
      Send: import_lucide.Send,
      ClipboardList: import_lucide.ClipboardList,
      Users: import_lucide.Users,
      Settings: import_lucide.Settings,
      Book: import_lucide.Book,
      LifeBuoy: import_lucide.LifeBuoy,
      Building2: import_lucide.Building2,
      ChevronLeft: import_lucide.ChevronLeft,
      ChevronRight: import_lucide.ChevronRight,
      Menu: import_lucide.Menu,
      X: import_lucide.X,
      Eye: import_lucide.Eye,
      EyeOff: import_lucide.EyeOff,
      AlertTriangle: import_lucide.AlertTriangle,
      CheckCircle: import_lucide.CheckCircle,
      Clock: import_lucide.Clock,
      Download: import_lucide.Download,
      Edit: import_lucide.Edit,
      Trash2: import_lucide.Trash2,
      Plus: import_lucide.Plus,
      Search: import_lucide.Search,
      Filter: import_lucide.Filter
    }
  };
  var reinitTimeout;
...
lucide/dist/cjs/lucide.js:
   ...
   *)
*/
//# sourceMappingURL=lucide.bundle.js.map
